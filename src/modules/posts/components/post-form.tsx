...
export function PostForm({ defaultValues, onSubmit, isPartialForm }:
  {
    defaultValues: UseFormProps<ICreatePostForm>["defaultValues"], onSubmit: (data: ICreatePostForm) => Promise<string | void>,
