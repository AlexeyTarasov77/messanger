...
export function UpdatePostModal({ postId, ...modalProps }: IModalBaseProps & { postId?: number }) {
  ...
  return (<PostModal {...modalProps} heading="Редагування публікації">{post && <PostForm
    {...modalProps}
